...
### Getting Started
You may try Cixl online [here](https://tio.run/#cixl). Linux/64 binaries may be found [here](https://github.com/basic-gongfu/cxbin/tree/master/linux64). To build Cixl yourself, you'll need a reasonably modern GCC and CMake installed. Building on macOS unfortunately doesn't work because of missing POSIX support. A basic REPL is included, it's highly recommended to run it through ```rlwrap``` for a less nerve wrecking experience.
