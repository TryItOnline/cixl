...
### Traits
Traits are abstract types, they are useful for simplifying type checking and/or function dispatch. Besides the standard traits; 'A', 'Num' and 'Opt'; new traits may be defined using the ```trait:``` macro.
