...
* add support for type-id type args
** add support for type args to add_type
*** get types and push as args
*** truncate id
** resolve type-id args and derive in type_init
*** add bool cx_type_is_arg(t)
**** scan type recursively for CX_TYPE_ARG
*** skip derive in macro parse if cx_type_is_arg()
** check typedef emit
* add type: macro
** add CX_TYPE
** type: Enc Str Int;
