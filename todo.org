...
* optimize cx_call args
** allocate static array with struct
** use fimp->func->nargs as count
** define CX_MAX_ARGS
* optimize OPUTARGS emit
** step pointer to arg instead of calling cx_call_arg
