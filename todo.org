* add DBTable.on_save_rec like load
** use to convert topics/users to stacks
** change table keys back to `id/`name
* change options to store pairs
** implement pair get fn (Sym `x/`y)
* break up handle-cmd
