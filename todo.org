* fix lib: emit
** remove emit_id from type/func/fimp
** remove emit_types/funcs/fimps
** call get_type/func/fimp instead
** test.cx
* move include: to cx/io
...
* add support for type literal args
** use _ for anonymous args
** interpret as type literal if no ids
* ---
