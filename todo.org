...
* fix throw recovery
** add separate op eval/emit to run if errors.count
** replaces new_error magic and catch jump
** deal with errors in catch ops
** change catch: to not wrap code
*** put after within same scope
** add support for throwing non-errors
*** store cx_box in throwing
*** add throwa fn and rename existing to throws
* --
* add cx_call.args
