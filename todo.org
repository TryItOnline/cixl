* calculate month/year days in days fn
* add day fn to get day of month
* add month-days fn to get days in month for time
* add date fn to trunc time
* add time fn to frac time
* add date fn for vect
** expect y m d
*** bind as many as are present
* add time fn for vect
** expect h m s ns
*** bind as many as are present
*---
* add ^ (pow)
