...
** change case to not wrap caught code
*** put call after code within same scope
** add support for thrown values that are not errors
*** add throw fn and rename existing to throw-unwind
