...
struct cx {
  ...
  struct cx_type *any_type, *bin_type, *bool_type, *char_type, *cmp_type, *file_type,
    *fimp_type, *func_type, *guid_type, *int_type, *lambda_type, *meta_type,
    *nil_type, *num_type, *opt_type, *rat_type, *rec_type, *rfile_type, *str_type,
    *sym_type, *time_type, *vect_type, *wfile_type;
