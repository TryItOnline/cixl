...
enum cx_tok_type { CX_TCUT, CX_TEND, CX_TFALSE, CX_TFUNC, CX_TGROUP, CX_TID,
		   CX_TLAMBDA, CX_TLITERAL, CX_TMACRO, CX_TNIL, CX_TTRUE, CX_TTYPE,
		   CX_TUNGROUP, CX_TUNLAMBDA };
